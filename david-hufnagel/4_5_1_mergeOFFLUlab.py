...
Update: Aug 12, 2023, this version is for lab tested strains instead of strains labeled only as variants
"""
import sys

inp_21a = open("offlu_2021a_h1_lab.fna")
inp_21b = open("offlu_2021b_h1_lab.fna")
inp_22a = open("offlu_2022a_h1_lab.fna")
inp_22b = open("offlu_2022b_h1_lab.fna")
inp_23a = open("offlu_2023a_h1_lab.fna")
out = open("offlu_h1_lab.fna", "w")
